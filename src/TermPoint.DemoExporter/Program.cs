...
namespace TermPoint.DemoExporter;
...
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        if (args.Length < 1 || args[0] is "-h" or "--help")
        {
            ...
            Console.WriteLine("  --output <dir>          Output directory (default: ../TermPoint/Demo/)");
            Console.WriteLine("  --academic-year <name>  Academic year to export (default: most recent)");
            return 1;
        }

        var dbPath = args[0];
        var outputDir = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "TermPoint", "Demo");
    ...
    private static StringBuilder Header()
    {
        ...
        sb.AppendLine("using TermPoint.Models;");
        sb.AppendLine();
        sb.AppendLine("namespace TermPoint.Demo;");
        sb.AppendLine();

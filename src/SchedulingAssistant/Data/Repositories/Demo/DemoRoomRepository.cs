...
/// <summary>
/// Read-only demo implementation of <see cref="IRoomRepository"/> backed by
/// <see cref="DemoData.Rooms"/>.  Write operations are no-ops.
/// </summary>
public class DemoRoomRepository : IRoomRepository
{
    ...
    /// <inheritdoc/>
    public void Insert(Room room) { /* no-op in demo */ }

    /// <inheritdoc/>
    public void Update(Room room) { /* no-op in demo */ }

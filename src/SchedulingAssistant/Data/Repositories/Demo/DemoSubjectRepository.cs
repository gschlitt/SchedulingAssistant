...
/// <summary>
/// Read-only demo implementation of <see cref="ISubjectRepository"/> backed by
/// <see cref="DemoData.Subjects"/>.  Write operations are no-ops.
/// </summary>
public class DemoSubjectRepository : ISubjectRepository
{
    ...
    /// <inheritdoc/>
    public void Insert(Subject subject) { /* no-op in demo */ }

    /// <inheritdoc/>
    public void Update(Subject subject) { /* no-op in demo */ }

...
/// <summary>
/// Read-only demo implementation of <see cref="IInstructorRepository"/> backed by
/// <see cref="DemoData.Instructors"/>.  Write operations are no-ops.
/// </summary>
public class DemoInstructorRepository : IInstructorRepository
{
    ...
    /// <inheritdoc/>
    public void Insert(Instructor instructor) { /* no-op in demo */ }

    /// <inheritdoc/>
    public void Update(Instructor instructor, DbTransaction? tx = null) { /* no-op in demo */ }
